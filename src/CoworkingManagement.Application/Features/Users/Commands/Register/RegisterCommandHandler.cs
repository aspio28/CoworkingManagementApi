...
internal sealed class RegisterCommandHandler(IApplicationDbContext context, IPasswordHasher passwordHasher, IJwtTokenGenerator jwt) : IRequestHandler<RegisterCommand, Unit>
{
